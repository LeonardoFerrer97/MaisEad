...
namespace MaisEad.Utils.Query
{
    public class FaculdadeQueries
    {
        ...
        public static string GET_FACULDADE_BY_NOME = "SELECT * FROM faculdade WHERE Nome = '@Nome";
        public static string UPDATE_FACULDADE_BY_ID = "UPDATE Faculdade SET Nome = '@Nome' , Endereco = '@Endereco',NotaMec = @NotaMec WHERE id = @Id";
