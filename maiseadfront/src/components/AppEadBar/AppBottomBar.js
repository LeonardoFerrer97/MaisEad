    ...
    render() {
        ...
        return <AppBar classes={{ root: classes.root }}>
            ...
            <div className='tutorial'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#F0F7EE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg"><line x1="7" y1="17" x2="17" y2="7"></line><polyline points="7 7 17 7 17 17"></polyline></svg>
                </div>
