    ...
    render() {
        return <div className='background'>
                ...
                <div class="grid-container">
                    <div class="grid-item"><p>Infraestrutura dos polos de apoio</p>
                        <StarRatings
                            ...
                            starHoverColor="blue"
                            disabled={true}
                            changeRating={this.props.isAvaliar ? (event) => this.props.handleChange(event, 'Infra') : () => { }}
                            numberOfStars={5}
                            name='rating'
                        />
                    </div>
                    <div class="grid-item"><p>Qualidade do material didático</p>
                        <StarRatings
                            ...
                            starHoverColor="blue"
                            disabled={true}
                            changeRating={this.props.isAvaliar ? (event) => this.props.handleChange(event, 'Material') : () => { }}
                            numberOfStars={5}
                            name='rating'
                        />
                    </div>
                    <div class="grid-item"><p>Organização do Ambiente Virtual de Aprendizagem</p>
                        <StarRatings
                            ...
                            starHoverColor="blue"
                            disabled={true}
                            changeRating={this.props.isAvaliar ? (event) => this.props.handleChange(event, 'Organizacao') : () => { }}
                            numberOfStars={5}
                            name='rating'
                        />
                    </div>
                    <div class="grid-item"><p>Nota do curso de 1 a 5</p>
                        <StarRatings
                            starDimension='20px'
                            rating={this.props.isAvaliar ? this.props.Nota : this.props.ead.avaliacaoUsuario.nota}
                            starRatedColor="#16cbdb"
                            starHoverColor="blue"
                            disabled={true}
                            changeRating={this.props.isAvaliar ? (event) => this.props.handleChange(event, 'Nota') : () => { }}
                            numberOfStars={5}
                            name='rating'
                        />
                    </div>
            ...
            <Snackbar
                ...
                open={this.props.snackBarToEnd}
                autoHideDuration={6000}
                onClose={this.props.handleClose}
                ContentProps={{
                    'aria-describedby': 'message-id',
                }}
                message={<span id="message-id">Obrigado por avaliar o curso.</span>}
                action={[
                    <IconButton
                        key="close"
                        aria-label="close"
